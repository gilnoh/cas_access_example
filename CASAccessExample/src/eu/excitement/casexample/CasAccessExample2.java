...
public class CasAccessExample2 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			viewJCas1.setDocumentText("The person is hired as a postdoc."); 
			viewJCas1.setDocumentLanguage("EN");
			viewJCas2.setDocumentText("The person must have a PhD.");
