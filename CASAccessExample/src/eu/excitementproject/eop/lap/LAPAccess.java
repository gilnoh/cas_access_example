...
// note this is a local copy of the interface, not the real one. 
...
* @since oct 1, 2012
*/
public interface LAPAccess { // need to be added // extends eu.excitementproject.eop.common.Components {
